...
function renderContact(array) {
    ul.innerHTML = array.map(({ name, surname, phoneNumber, userEmail }, index)=>{
        return `
...
form.addEventListener("submit", (event)=>{
    ...
    if (!name || !surname || !phoneNumber || !userEmail) {
        ...
        if (editIndex !== null) contacts[editIndex] = payload;
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire37a7", {})

//# sourceMappingURL=js-homework9-from-part4.0f77c784.js.map
